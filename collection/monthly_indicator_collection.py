...
from utils.indicator import transform_monthly_indicator_data
...
MONTHLY_INDICATORS = ['FEDERAL_FUNDS_RATE', 'CPI', 'UNEMPLOYMENT', 'RETAIL_SALES', 'NONFARM_PAYROLL']

with open('../sql_generated/monthly_indicator.sql', mode='w+') as f:
    ...
    for indicator in MONTHLY_INDICATORS:
        ...
        indicator_details = transform_monthly_indicator_data(
